...
local BtnStroke = Instance.new("UIStroke")
 ...
 BtnStroke.Name = "BtnStroke"
             ...
             BtnStroke.Color = Color3.fromRGB(238, 44, 44)            BtnStroke.LineJoinMode = Enum.LineJoinMode.Round
...
Page.BackgroundTransparency = 4.10
Page.Position = UDim2.new(0.400426834, 0, 0.075000003, 0)
Page.Size = UDim2.new(0, 263, 0, 325)
Page.Image = "http://www.roblox.com/asset/?id=" .. tostring(95088864100885)
...
ttittles.Text = "Bap Red"
ttittles.TextSize = 17.000
ttittles.TextColor3 = Color3.fromRGB(238, 44, 44)
...
local Logo = Instance.new("ImageLabel")
	Logo.Name = "https://mx.pinterest.com/pin/699817229636462095/"
	Logo.Parent = Main
...
local imgLabelIcon = Instance.new("ImageLabel")
				...
				imgLabelIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				imgLabelIcon.BackgroundTransparency = 5.000
...
Textbox.BackgroundColor3 = Color3.new(238, 44, 44)
...
L2.Image = "rbxassetid://110905876048511"
L2.Draggable = true
...
local Mn = A:T("chung","rbxassetid://15712703260")
local St = A:T("Cài Đặt ","rbxassetid://15712711639")
local M = A:T("Vật Phẩm","rbxassetid://15712717270")
local V4 = A:T("Tộc Và Đảo Bí Ẩn","rbxassetid://15712776421")
...
local T = A:T("Di Chuyển","rbxassetid://15712738876")
local S = A:T("Cửa Hàng","rbxassetid://10734952479")
local D = A:T("Trái Ác Quỷ","rbxassetid://15712758182")
...
Mn:Toggle("Nhặt Rương Ở Đảo Bí Ẩn",false,function(V)
 _G.ChestMirage = V
...
BoneCheck = Mn:Label("Xương Của Bạn: N/A")
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    spawn(function()
        while wait() do 
            if Mode == "NoQuest" and _G.Bone and World3 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
...
St:Toggle("Đánh Nhanh",true,function(V)
_G.FastAttack = V
end)

St:Toggle("Đánh Không Chuyển Động",true,function(V)
NoAttackAnimation = V
end)
...
St:Toggle("Đánh Người Chơi",false,function(V)
_G.AttackMob = V
end)

 spawn(function()
     while wait() do
         if _G.AttackMob and not _G.FarmFruitMastery and not _G.FarmGunMastery then
             pcall(function()
                 AttackNoCD()
             end)
         end
...
function AttackNoCD()
    if not _G.FarmFruitMastery or not _G.FarmGunMastery then
        if _G.FastAttack then
...
M:Toggle("Lấy Tushita", _G.tushita,function(V)
    ...
    M:Toggle("Lấy Auto Soul Guitar ( Thử Nghiệm )",_G.Guitar,function(V)
  _G.Guitar = V    
 StopTween(_G.Guitar)
 end)
...
M:Toggle("Lấy Soul Guitar Đổi Sever",false,function(V)
  _G.soulGuitarhop = V    
 end)
 ...
 M:Seperator("Song Kiếm")

M:Toggle("Lấy Song Kiếm ( Thử Nghiệm )",_G.Cdk,function(V)
 _G.CDK = V
StopTween(_G.CDK)
end)
...
V4:Toggle("Tự Động Đảo Bí Ẩn",_G.MysticIsland,function(V)
    ...
    V4:Toggle("Tự Động Lái",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
...
local Boats = E:Dropdown("Chọn Thuyền",BoatsName,function(plys)
  _G.SelectB = plys
end)
    
E:Button("Đặt Lại",function()
  BoatsName = {}
  Boats:Clear()
  for i,v in pairs(game:GetService("Workspace").Boats:GetChildren()) do  
     Boats:Add(v.Name)
...
E:Button("Dịch Chuyển Đến Thuyền",function()
...
E:Toggle("Bay Đến Thuyền",_G.TPB,function(bool)
   _G.TPB = bool       
 StopTween(_G.TPB)
...
E:Toggle("Quan Sát Thuyền",false,function(bool)
  Sp = bool
...
E:Seperator("Biển động")
    
    E:Toggle("Thuyền lái tự động", _G.DriveBoat,function(V)
         _G.DriveBoat = V
                ...
                if _G.DriveBoat then
                    if not game:GetService("Workspace").Enemies:FindFirstChild("Shark") or not game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") or not game:GetService("Workspace").Enemies:FindFirstChild("Piranha") or not game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") then
                        if not game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                            buyb = TP1(CFrame.new(-16927.451171875, 9.0863618850708, 433.8642883300781))
                        ...
                        elseif game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                            if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == false then
                                TP1(game:GetService("Workspace").Boats.PirateBrigade.VehicleSeat.CFrame * CFrame.new(0,1,0))
                            else
                                for i,v in pairs(game:GetService("Workspace").Boats:GetChildren()) do
                                    if v.Name == "PirateBrigade" then
                                        ...
                                        until game:GetService("Workspace").Enemies:FindFirstChild("Shark") or game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") or game:GetService("Workspace").Enemies:FindFirstChild("Piranha") or game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") or _G.DriveBoat == false
                                    end
                                end
                            end
                        end
    ...
    E:Toggle("Xuyên Đá", _G.Terrorshark,function(V)
         _G.NoClipRock = V
    end)
    ...
    E:Toggle("Đánh Terrorshark", _G.Terrorshark,function(V)
         _G.Terrorshark = V
        StopTween( _G.Terrorshark)
    end)
    
    E:Toggle("Đánh Shark",FarmTFully,function(V)
    FarmShark = V
    StopTween(FarmShark)
    end)
    ...
    E:Toggle('Bay Đến Seabeat', false, function(V)
    _G.SeaBest = V
...
E:Toggle("Tự Động Sea Beast",_G.Seabest,function(V)
_G.Seabest = V
StopTween(_G.Seabest)
end)
...
task.spawn(function()
                                ...
                                elseif game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == true then
                                    repeat wait()
                                        if (game:GetService("Workspace").Boats.PirateBrigade.VehicleSeat.CFrame.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 10 then
                                            TP1(CFrame.new(35.04552459716797, 17.750778198242188, 4819.267578125))
                                        end
                                    until game:GetService("Workspace").SeaBeasts:FindFirstChild("SeaBeast1") or _G.Seabest == false
                                end
                            end
                                ...
                                if vs.Name == "PirateBrigade" then
                                    if vs:FindFirstChild("VehicleSeat") then
                                        repeat wait()
                                            ...
                                            TP1(vs.VehicleSeat.CFrame * CFrame.new(0,30,0))
                                            EquipAllWeapon()  
                                            AutoSkill = true
                                            AimBotSkillPosition = vs.VehicleSeat
                                            Skillaimbot = true
                                        until not game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") or _G.Seabest == false
                                        AutoSkill = false
                                        Skillaimbot = false
                                    end
                                end
                        ...
                        for iss,vss in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if vss.Name == "PirateBasic" then
                                if vss:FindFirstChild("VehicleSeat") then
                                    repeat wait()
                                        game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
                                        TP1(vss.VehicleSeat.CFrame * CFrame.new(0,30,0))
                                        EquipAllWeapon()  
                                        AutoSkill = true
                ...
                elseif game:GetService("Workspace").SeaBeasts:FindFirstChild("SeaBeast1") then  
                    for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
                        if v:FindFirstChild("HumanoidRootPart") then
                            repeat wait()
                                game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(0,500,0))
                                EquipAllWeapon()  
                                AutoSkill = true
                                AimBotSkillPosition = v.HumanoidRootPart
                                Skillaimbot = true
                            until not v:FindFirstChild("HumanoidRootPart") or _G.Seabest == false
                            AutoSkill = false
                            Skillaimbot = false
                        end
                    end
    ...
    E:Toggle("Đánh Fish Crew Member",_G.Fish_Crew_Member,function(V)
    ...
    E:Toggle("Đánh Raid Ship",_G.KillGhostShip,function(V)
    _G.KillGhostShip = V
...
spawn(function()
    ...
    E:Toggle("Bay Đến Frozen Dimension",_G.FrozenDimension,function(V)
    _G.FrozenDimension = V
    StopTween(_G.FrozenDimension)
    end)
    
    E:Seperator("Sự Kiện Kitsune")
    
    E:Toggle("Tự Động Đảo Kitsune",_G.FKitsune,function(V)
    _G.FKitsune = V
...
E:Toggle("Bay Đến Đảo Kitsune", false, function(V)
    _G.tpkit = V
    StopTween(_G.tpkit)
end)
...
E:Toggle("Nhặt Linh hồn", false, function(V)
    _G.CltAze = V
    StopTween(_G.CltAze)
...
E:Button("Đổi Linh Hồn",function()
...
-------------------------------------------------------------------------------------------------------- 
    ...
    R:Button("Bắt Đầu Đột Kích",function()
        ...
        R:Button("Đảo Tiếp Theo",function()
        pcall(function()
        ...
        R:Toggle("Tự Động Đảo Tiếp Theo",_G.Dungeon,function(V)
        _G.Dungeon = V
